...
class MainActivityTest {
    ...
    fun assertGetCircumference() {
        // find view -> set event text type and close the keyboard
        ...
        // find btn save -> check is button displayed or not
        onView(withId(R.id.btn_save)).check(matches(isDisplayed()))

        // find btn save -> set event click
        onView(withId(R.id.btn_save)).perform(click())


        // find btn circum_reference -> check is button displayed or not
        onView(withId(R.id.btn_calculate_circumference)).check(matches(isDisplayed()))

        // find btn circum_reference -> set event click
        onView(withId(R.id.btn_calculate_circumference)).perform(click())

        // find text view result -> check is result displayed or not
        onView(withId(R.id.tv_result)).check(matches(isDisplayed()))

        // find text view result -> check is result is same with dummyCircumference
